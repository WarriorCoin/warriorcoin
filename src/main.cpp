...
uint256 hashGenesisBlock("0x32a2925e8cbdb7f72b1003d69fd44f51a3f1f1c101fc6a1aa2874a45dede1625");
...
const string strMessageMagic = "WarriorCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.5 * 24 * 60 * 60; // WarriorCoin: 0.5 days
static const int64 nTargetSpacing = 90; // WarriorCoin: 90 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal warriorcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WarriorCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x66d34fdfaa838d9375fd51281d3f4e6149d3618695e93ded72c47772ec9fe695");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "UCLA vs BYU Volleyball on 5/3/18: Maleski rips an ACE! and the Bruins take Set 4, 25-19! UCLA wins the match 3-1 (25-22, 24-26, 29-27, 25-19) and advances to the #NCAA Championship match vs. @lbsumvb on Sat., May 5 at 4pm.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525651500;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086089705;

        if (fTestNet)
        {
            block.nTime    = 1525625256;
            block.nNonce   = 388185453;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb7ffcb18b3140cde4f5b78e5e4101435d33c41db7552b5b9430658f6513c735e"));
